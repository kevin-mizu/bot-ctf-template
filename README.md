...
- For CTF players:
  ...
  * Just like for challenge makers, an easy way to share solutions after the CTF (for example: https://mizu.re/post/fcsc-2025-writeups#dom-monitor-part1-solution-script).
